            ...
            <div class="card">
                ...
                <form action="/questionaires" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <small id="titleHelp" class="form-text text-muted">Give your title of survey.</small>
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <small id="purposeHelp" class="form-text text-muted">Give your purpose of survey.</small>
                        @error('purpose')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
